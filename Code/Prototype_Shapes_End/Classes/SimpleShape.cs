...
namespace Prototype_Shapes_End.Classes
{
    ...
    public class SimpleShape : DependencyObject, ICloneable
    {
        public double Width
        {
        ...
        public object Clone()
        {
            var clone = this.MemberwiseClone() as SimpleShape;

            // place the clone just a bit sideways from the original object
            clone.Left += 30;
            clone.Top += 30;
